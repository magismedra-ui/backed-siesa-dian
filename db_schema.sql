...
CREATE TABLE IF NOT EXISTS `sys_usuarios` (
  ...
  CONSTRAINT `fk_usuario_rol` FOREIGN KEY (`rol_id`) REFERENCES `sys_roles` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `proc_ejecuciones` (
  ...
  `updatedAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_ejecucion_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `sys_usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `proc_documentos_staging` (
  ...
  `updatedAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_staging_ejecucion` FOREIGN KEY (`ejecucion_id`) REFERENCES `proc_ejecuciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `repo_resultados` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `ejecucion_id` INT(11) NOT NULL,
  `tipo_resultado` ENUM('CONCILIADO', 'NO_EN_SIESA', 'NO_EN_DIAN', 'DIFERENCIA_VALOR') NOT NULL,
  ...
  `updatedAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_resultado_ejecucion` FOREIGN KEY (`ejecucion_id`) REFERENCES `proc_ejecuciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
